export default function Home() {
  return (
    ...
    dark:bg-gray-700">
      <div className="max-w-screen-sm bg-white shadow-lg p-5 rounded-3xl w-full
      dark:bg-gray-600">
        <div className="flex justify-between items-center">
          <div className="flex flex-col">
            <span className="text-gray-600 dark:text-gray-300 font-semibold -mb-1">In Transit</span>
            <span className="dark:text-white font-semibold">Coolblue</span>
          </div>
        ...
        <div className="my-2 flex items-center gap-2">
          ...
          font-medium rounded-full transition hover:bg-green-500 hover:scale-110">
            Today</span>
